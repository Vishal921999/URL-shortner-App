  ...
  const handleSubmit = async (e:React.FormEvent<HTMLFormElement>) => {
    ...
    <div className = "container mx-auto p-2">
        <div className='bg-banner my-8 rounded-xl bg-cover bg-center'>
            ...
            <p className = "text-white text-center pb-2 text-xl font-extralight">Paste your URL link to shorten it.</p>
            <p className='text-white text-center pb-4 text-sm font-thin'>This URL Shortner creates a shortened and neat link for you</p>
                ...
                <div className = "flex">
                    <div className = 'relative w-full'>
                        ...
                        <input 
                            ...
                            value = {fullUrl}
                            onChange = {(e: React.ChangeEvent<HTMLInputElement>) => setFullUrl(e.target.value)}></input>
